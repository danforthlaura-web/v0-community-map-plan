          ...
          <div className="p-4 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card rounded-lg p-3 text-center border border-border">
                <div className="text-2xl font-bold text-primary">{submission.number_of_learners || 'N/A'}</div>
                <div className="text-xs text-muted-foreground">Learners</div>
              </div>
              <div className="bg-card rounded-lg p-3 text-center border border-border">
                <div className="text-2xl font-bold text-primary">{submission.number_of_teachers || 'N/A'}</div>
            ...
            {/* Basic Details */}
            <div>
              <h4 className="text-sm font-semibold text-foreground mb-2">Basic Details</h4>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                {submission.device_usage && submission.device_usage.length > 0 && (
                  <div>
                    <h4 className="text-sm font-semibold text-foreground mb-2">Device Usage</h4>
                    <div className="flex flex-wrap gap-1">
                ...
                {submission.hardware_model && submission.hardware_model.length > 0 && (
                  <div>
                    <h4 className="text-sm font-semibold text-foreground mb-2">Hardware Model</h4>
                    <div className="flex flex-wrap gap-1">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {submission.testimonials && (
                    <p><span className="text-muted-foreground">Testimonials:</span> {submission.testimonials}</p>
                  )}
                  {submission.reports && (
                    <p>
            ...
            <div>
              ...
              <div className="space-y-1 text-sm">
                <p><span className="text-muted-foreground">Receive updates:</span> {submission.receive_updates ? 'Yes' : 'No'}</p>
                <p><span className="text-muted-foreground">Email visible:</span> {submission.email_visible ? 'Yes' : 'No'}</p>
              </div>
            </div>
